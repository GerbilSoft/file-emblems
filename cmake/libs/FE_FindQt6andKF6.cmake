...
MACRO(FIND_QT6_AND_KF6)
	...
	IF(ECM_MODULE_PATH AND ECM_KDE_MODULE_DIR AND ECM_VERSION VERSION_GREATER 5.247)
		...
		FIND_PACKAGE(Qt6 ${REQUIRE_KF6} COMPONENTS Core Gui Widgets)
  ...
  - Red Hat/Fedora: qt6-qttools")
			...
			#FIND_PACKAGE(KF6 ${REQUIRE_KF6} ${KF6_MIN} COMPONENTS KIO WidgetsAddons Crash)
			FIND_PACKAGE(KF6 ${REQUIRE_KF6} COMPONENTS KIO)# WidgetsAddons Crash)
			IF(NOT KF6KIO_FOUND)# OR NOT KF6WidgetsAddons_FOUND OR NOT KF6Crash_FOUND)
				# KF6 not found.
				SET(BUILD_KF6 OFF CACHE INTERNAL "Build the KDE Frameworks 6 plugin." FORCE)
			ENDIF(NOT KF6KIO_FOUND)# OR NOT KF6WidgetsAddons_FOUND OR NOT KF6Crash_FOUND)
